...
if ($PSVersionTable.PSVersion -lt "6.0" -or $IsWindows) {
  ...
  $new_node_path="$basedir/E:/eclipse-workspace/OnlineFlowerTransactionManagementSystem-main/src/main/webapp/admin/node_modules/.store/semver@6.3.1/node_modules"
}
